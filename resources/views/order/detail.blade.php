        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                    ...
                    <p class="mb-0 fs-10">
                        <strong>Email: </strong><a href="mailto:ricky@gmail.com">antony@example.com</a>
                    </p>
                    <p class="mb-0 fs-10">
                        <strong>Phone: </strong><a href="tel:7897987987">7897987987</a>
                    </p>
                </div>
                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                ...
                <div class="col-md-6 col-lg-4">
                    ...
                    <div class="d-flex">
                        <img class="me-3" src="../../../assets/img/icons/visa.png" width="40" height="30"
                            alt="" />
                        <div class="flex-1">
