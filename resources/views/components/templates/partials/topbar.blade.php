<nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
    ...
    <ul class="navbar-nav navbar-nav-icons ms-auto flex-row align-items-center">
        ...
        <li class="nav-item mb-1">
            <a
                class="js-acc-btn text-primary text-decoration-none fs--1 font-sans-serif fw-bolder text-uppercase">{{ Auth::user()->name }}</a>
        </li>

        <li class="nav-item dropdown"><a class="nav-link pe-0" id="navbarDropdownUser" href="#"
                role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="avatar avatar-xl">
                    <img class="rounded-circle" src="{{ asset('dist/assets/img/team/avatar.png') }}"
                        alt="" />
            ...
            <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    ...
                    <!-- Membuat elemen a:href untuk mentrigger modal logut -->
...
@push('scripts')
    <!-- Membuat ajax logout dari button dengan id logout -->
    <script>
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            /* Jika berhasil, maka akan redirect ke halaman login */
